...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'elao.form_translation.extension.button_type_extension' => 'getElao_FormTranslation_Extension_ButtonTypeExtensionService',
            'elao.form_translation.extension.choice_type_extension' => 'getElao_FormTranslation_Extension_ChoiceTypeExtensionService',
            'elao.form_translation.extension.collection_type_extension' => 'getElao_FormTranslation_Extension_CollectionTypeExtensionService',
            'elao.form_translation.extension.form_type_extension' => 'getElao_FormTranslation_Extension_FormTypeExtensionService',
            'elao.form_translation.key_builder' => 'getElao_FormTranslation_KeyBuilderService',
            'elao.form_translation.tree_builder' => 'getElao_FormTranslation_TreeBuilderService',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9f8fe1aa4d35629dbcef5bfe9b4e232f2ab121dcb790fcb8fea840b56c4e1e95');
    ...
    /**
     * Gets the 'elao.form_translation.extension.button_type_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Elao\Bundle\FormTranslationBundle\Form\Extension\ButtonTypeExtension A Elao\Bundle\FormTranslationBundle\Form\Extension\ButtonTypeExtension instance.
     */
    protected function getElao_FormTranslation_Extension_ButtonTypeExtensionService()
    {
        $this->services['elao.form_translation.extension.button_type_extension'] = $instance = new \Elao\Bundle\FormTranslationBundle\Form\Extension\ButtonTypeExtension();

        $instance->setAutoGenerate(true);
        $instance->setTreebuilder($this->get('elao.form_translation.tree_builder'));
        $instance->setKeybuilder($this->get('elao.form_translation.key_builder'));
        $instance->setKeys(array('label' => 'label', 'help' => 'help'));

        return $instance;
    }

    /**
     * Gets the 'elao.form_translation.extension.choice_type_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Elao\Bundle\FormTranslationBundle\Form\Extension\ChoiceTypeExtension A Elao\Bundle\FormTranslationBundle\Form\Extension\ChoiceTypeExtension instance.
     */
    protected function getElao_FormTranslation_Extension_ChoiceTypeExtensionService()
    {
        $this->services['elao.form_translation.extension.choice_type_extension'] = $instance = new \Elao\Bundle\FormTranslationBundle\Form\Extension\ChoiceTypeExtension();

        $instance->setAutoGenerate(true);
        $instance->setTreebuilder($this->get('elao.form_translation.tree_builder'));
        $instance->setKeybuilder($this->get('elao.form_translation.key_builder'));
        $instance->setKeys(array('label' => 'label', 'help' => 'help', 'empty_value' => 'empty_value'));

        return $instance;
    }

    /**
     * Gets the 'elao.form_translation.extension.collection_type_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Elao\Bundle\FormTranslationBundle\Form\Extension\CollectionTypeExtension A Elao\Bundle\FormTranslationBundle\Form\Extension\CollectionTypeExtension instance.
     */
    protected function getElao_FormTranslation_Extension_CollectionTypeExtensionService()
    {
        $this->services['elao.form_translation.extension.collection_type_extension'] = $instance = new \Elao\Bundle\FormTranslationBundle\Form\Extension\CollectionTypeExtension();

        $instance->setAutoGenerate(true);
        $instance->setTreebuilder($this->get('elao.form_translation.tree_builder'));
        $instance->setKeybuilder($this->get('elao.form_translation.key_builder'));
        $instance->setKeys(array('label' => 'label', 'help' => 'help', 'label_add' => 'label_add', 'label_delete' => 'label_delete'));

        return $instance;
    }

    /**
     * Gets the 'elao.form_translation.extension.form_type_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Elao\Bundle\FormTranslationBundle\Form\Extension\FormTypeExtension A Elao\Bundle\FormTranslationBundle\Form\Extension\FormTypeExtension instance.
     */
    protected function getElao_FormTranslation_Extension_FormTypeExtensionService()
    {
        $this->services['elao.form_translation.extension.form_type_extension'] = $instance = new \Elao\Bundle\FormTranslationBundle\Form\Extension\FormTypeExtension();
    ...
    /**
     * Gets the 'elao.form_translation.key_builder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Elao\Bundle\FormTranslationBundle\Builders\FormKeyBuilder A Elao\Bundle\FormTranslationBundle\Builders\FormKeyBuilder instance.
     */
    protected function getElao_FormTranslation_KeyBuilderService()
    {
        return $this->services['elao.form_translation.key_builder'] = new \Elao\Bundle\FormTranslationBundle\Builders\FormKeyBuilder('.', 'form', 'children', 'prototype');
    }

    /**
     * Gets the 'elao.form_translation.tree_builder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Elao\Bundle\FormTranslationBundle\Builders\FormTreeBuilder A Elao\Bundle\FormTranslationBundle\Builders\FormTreeBuilder instance.
     */
    protected function getElao_FormTranslation_TreeBuilderService()
    {
        return $this->services['elao.form_translation.tree_builder'] = new \Elao\Bundle\FormTranslationBundle\Builders\FormTreeBuilder();
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2d5ec57c8503769e1e9699439f75e5f27ab2236b');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56b1b9aeeab7a0.71772686')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ElaoFormTranslationBundle' => 'Elao\\Bundle\\FormTranslationBundle\\ElaoFormTranslationBundle',
            ...
            'secret' => '2d5ec57c8503769e1e9699439f75e5f27ab2236b',
            'locale' => 'en',
            ...
            'kernel.secret' => '2d5ec57c8503769e1e9699439f75e5f27ab2236b',
            ...
            'elao.form_translation.tree_builder.class' => 'Elao\\Bundle\\FormTranslationBundle\\Builders\\FormTreeBuilder',
            'elao.form_translation.key_builder.class' => 'Elao\\Bundle\\FormTranslationBundle\\Builders\\FormKeyBuilder',
            'elao.form_translation.extension.form_type_extension.class' => 'Elao\\Bundle\\FormTranslationBundle\\Form\\Extension\\FormTypeExtension',
            'elao.form_translation.extension.collection_type_extension.class' => 'Elao\\Bundle\\FormTranslationBundle\\Form\\Extension\\CollectionTypeExtension',
            'elao.form_translation.extension.button_type_extension.class' => 'Elao\\Bundle\\FormTranslationBundle\\Form\\Extension\\ButtonTypeExtension',
            'elao.form_translation.extension.choice_type_extension.class' => 'Elao\\Bundle\\FormTranslationBundle\\Form\\Extension\\ChoiceTypeExtension',
